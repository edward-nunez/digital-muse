...
export class TrainScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("TrainBg", "assets/backgrounds/TrainBg.png");
    this.load.audio("TrainBgMusic", "assets/sounds/music/TrainBgMusic.mp3");
  ...
  create() {
    ...
    const bg = this.add.image(0, 0, "TrainBg");
    bg.setOrigin(0, 0);
    ...
    this.menu = new DefaultMenu(this, {
      options: [
        ...
        { label: "Train", x: cam.width - 60, y: 30 },
      ],
